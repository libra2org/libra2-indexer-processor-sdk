use libra2_indexer_transaction_stream::utils::time::{
...
pub struct TransactionMetadata {
    ...
    pub end_version: u64,
    pub start_transaction_timestamp: Option<libra2_protos::util::timestamp::Timestamp>,
    pub end_transaction_timestamp: Option<libra2_protos::util::timestamp::Timestamp>,
